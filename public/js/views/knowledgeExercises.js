...
pageApp.controller('pageCtrl', function ($scope, $http) {
  ...
  $scope.loadFileList = function(){
    $http.get(`/knowledge/exercises/files?technologyID=${$scope.model.technologyID}&learningPhaseID=${$scope.model.learningPhaseID}&knowledgeID=${$scope.model.knowledgeID}`).then(function successCallback (response) {
