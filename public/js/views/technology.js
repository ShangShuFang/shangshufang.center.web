...
pageApp.controller('pageCtrl', function($scope, $http) {
    ...
    $scope.loadCategory = function() {
        $http.get(`/common/category?directionID=${$scope.model.selectedDirection.directionID}`)
            .then(function successCallback(response) {
                ...
                $scope.model.selectedCategory = $scope.model.add ? { technologyCategoryID: 0, technologyCategoryName: '全部技术类型' } : { technologyCategoryID: $scope.model.selectedCategoryTemp.technologyCategoryID, technologyCategoryName: $scope.model.selectedCategoryTemp.technologyCategoryName };
    ...
    $scope.onChangeThumbnailRectangle = function() {
        $http.put('/technology/thumbnail', {
            technologyID: $scope.model.technologyID_thumbnailRectangle,
            technologyThumbnailSquare: $scope.model.technologyThumbnailSquare,
            technologyThumbnailRectangle: $scope.model.technologyThumbnailRectangle,
            loginUser: $scope.model.loginUser.adminID
        }).then(function successCallback(response) {
